...
dag = DAG(
        'fitri_airflowtask2',
        description='Hello, Ini DAG Task2 Fitri',
...
create_table_task = PostgresOperator(
    ...
    postgres_conn_id='pg_conn_fitri',
    sql="""
    CREATE TABLE IF NOT EXISTS fitri_gender_name_prediction_task2 (
        input JSONB,
        details JSONB,
...
def load_predictions_to_postgres(**kwargs):
    ...
    pg_hook = PostgresHook(postgres_conn_id='pg_conn_fitri')
    for prediction in predictions:
        ...
        pg_hook.run("""
            INSERT INTO fitri_gender_name_prediction_task2 (input, details, result_found, first_name, probability, gender)
            VALUES (%s, %s, %s, %s, %s, %s);
